...
class NgOpenApiGen {
    ...
    generate() {
        ...
        if (fs_extra_1.default.existsSync(this.tempDir)) {
            fs_extra_1.default.emptyDirSync(this.tempDir);
        }
        else {
        ...
        rimraf_1.default.sync(this.tempDir);
    ...
    readModels() {
        ...
        for (const name of Object.keys(schemas)) {
            ...
            const model = new model_1.Model(name, schema, this.options);
